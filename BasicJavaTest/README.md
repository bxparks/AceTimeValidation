...
`validation_data.cpp` file generated by the [compare_java](tools/compare_java)
Java program.

## Running the Test

The Java tool generates about 199,000 data points spanning the year 2000 to
...
`AceTimeTools/compare_java/GenerateData.java` program into a
`GenerateData.class` if it has not already been generated. To compile manually,

```
$ cd .../AceTimeTools/compare_java
$ make
```
